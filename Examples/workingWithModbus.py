...
if __name__ == '__main__':
    ...
    if isU3:
        print("Setting FIO0-3 to analog, and the rest to digital...", end=' ')
    ...
    for i in range(4):
        ...
        print("Setting FIO%s to output %s (register %s = %s )..." % (fio, wordState, stateRegister, state), end=' ')
    ...
    for i in range(2):
        ...
        print("Setting DAC%s to %s Volts..." % (i, voltage), end=' ')
